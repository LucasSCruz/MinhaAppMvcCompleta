...
namespace DevIo.App.Controllers
{
    public class ProdutosController : BaseController
    {
        ...
        private readonly IFonecedorRepository _fornecedorRepository;
        private readonly IMapper _mapper;

        public ProdutosController(IProdutoRepository produtoRepository, IMapper mapper, IFonecedorRepository fornecedorRepository)
        {
